...
export const state={userId:getUser(),route:"home",room:null,history:storage.get("mock-history",[]),settings:storage.get("settings",{theme:"system"}),loading:false,lanyuMissionId:null,lanyuBottleDraft:"",lanyuOpenedBottles:{}};
